...
def main():
    ...
    dessin.create_text(1130, 25, font=('Centaur', 15, "bold", "underline"), text='Bateaux :', fill = "black")
...
#---------------------------------------------#
    ...
    class Tableau_joueur:                                     #defini l'objet tableau
        """
    ...
    class Tableau_ordi:                                     #defini l'objet tableau
        """
...
#------------------------------------------------------------------------------#
    ...
    class Bateau:
        ...
        def __init__(self, rota, pos, case_joueur, case_ordi, longeur_case_joueur, longeur_case_ordi):
    ...
    sm = Bateau(rota, pos, case_joueur, case_ordi, longeur_case_joueur, longeur_case_ordi).SousMarin()
